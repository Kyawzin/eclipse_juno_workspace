...
public class Validator {
    ...
    static {
        ...
        key = "Email.Regex.SIMPLE";
        _defaults.put(key, "^[A-Z0-9._%+-]+@[A-Z0-9.-]+\\.[A-Z]{2,4}$");
        ...
        key = "Email.Regex";
        _defaults.put(key, _defaults.get("Email.Regex.SIMPLE"));
    ...
    public static boolean isValidPort(int value) {
    ...
    public static boolean isValidDomain(String value) throws Exception {
